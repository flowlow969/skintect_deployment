...
def predict(filename):
    ...
    prediction = model.predict([prepare('static/uploads/'+ filename)]) # Klassifizierung vornehmen
    print(prediction)  # Klassifizierung ausgeben
    return CATEGORIES[int(prediction[0][0])], lesion_danger[int(prediction[0][0])] # lesions typ und Gefährlickeit zurückgeben
