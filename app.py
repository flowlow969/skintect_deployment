...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        if i == 1:  # überprüfen ob die Hautveränderung benigne oder maligne ist
            ...
            flash('Diese Hautveränderung ist wahrscheinlich  ein ' + detection + " und wahrscheinlich benigne.", category="success") # Art der veränderung ausgeben (benigne=Gutartige)
